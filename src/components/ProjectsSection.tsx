            ...
            >
              ...
              <div className="p-6 flex flex-col flex-1">
                <div className="mb-3">
                  ...
                  <p className="text-base text-primary font-medium">{p.subtitle}</p>
                </div>

                <ul className="space-y-1.5 text-base text-muted-foreground mb-4 list-disc pl-5 flex-1">
                ...
                <div className="flex gap-2 flex-wrap mb-4">
                  {p.tags.map((tag) => (
                    <span
                      key={tag}
                      className="text-sm px-2.5 py-1 rounded-md bg-muted/80 text-foreground/80 font-medium border border-border/40"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="flex gap-3 mt-auto">
                  <a
                    ...
                    className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-base font-medium bg-muted/80 text-foreground hover:bg-muted border border-border/50 transition-colors"
                  >
                    <Code2 size={16} />
                    Code
                  </a>
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer noopener"
                    className="flex-1 inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-lg text-base font-medium text-primary-foreground hover:opacity-90 transition-opacity"
                    style={{ background: "var(--hero-gradient)" }}
